...
import static mailmerge.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static mailmerge.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static mailmerge.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import mailmerge.IntegrationTest;
import mailmerge.repository.UserRepository;
import mailmerge.security.AuthoritiesConstants;
