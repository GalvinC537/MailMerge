...
describe('Project Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const user: IUser = { id: '95513cd0-801c-478d-8400-07a1691ad017' };
      project.user = user;

      const userCollection: IUser[] = [{ id: '62109e4e-f1cf-4c44-9ef8-0b0e33ceeb87' }];
    ...
    it('Should update editForm', () => {
      const project: IProject = { id: 456 };
      const user: IUser = { id: '1d2b17f5-c75d-4761-a5de-485e6b308014' };
      project.user = user;
